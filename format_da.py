...
'''
1.045 - это коэффициент, который учитывает насколько увеличится число после добавления 4.5%. Когда вы добавляете 4.5% к числу, вы увеличиваете его на 0.045 (4.5% как десятичная дробь). Чтобы получить итоговое число с учетом увеличения на 4.5%, нужно умножить исходное число на коэффициент 1.045.

Например, если у вас есть число 100 и вы хотите увеличить его на 4.5%, вы можете использовать следующую формулу:

Итоговое число = исходное число * 1.045
Итоговое число = 100 * 1.045 = 104.5

Таким образом, 1.045 показывает насколько нужно увеличить исходное число на 4.5%. Если вы хотите уменьшить число на 4.5%, вам нужно использовать коэффициент 0.955 (1 - 0.045).
'''